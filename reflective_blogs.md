...
**Reflection:** So far, we have completed a website setup, memo analysis, and specialized chatbot created through BoodleBox. Personally, I really enjoyed the website setup. Learning how to navigate GitHub, code in Markdown, fork from other projects, and experiment with HTML was both engaging and fulfilling. It was relatively straightforward but still managed to scratch a technical itch.

The easiest part of this assignment was getting familiar with the basic structure of GitHub and Markdown. Once I understood how repositories, commits, and forks worked, I felt more confident making changes and experimenting. However, the more challenging aspect was troubleshooting code errors in my HTML and understanding how different elements interacted. I also struggled with writing a sleak introductary page for my portfolio. 

Overall, this deliverable reinforced my enjoyment of hands-on technical work and problem-solving. It also highlighted the importance of keeping my work clean and well-structured, particularly when building a portfolio for future job opportunities and internships. I clearly could use some brushing-up on my technical writing skills.
